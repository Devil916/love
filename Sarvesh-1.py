...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update SARVESH_SINGH Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + '  INSTAGRAM ACCOUNT ')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('NOT AVAILABLE✓')
	    psb('WellCome Haweli')
	    psb('Congratulations Sarvesh Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Alone✓')
	    psb('🔓Password ☆ Boy✓')
	    psb('Follow  My Insta Account✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Sarvesh && python2 Sarvesh12.py')
	elif bm =='3':
	    os.system('xdg-open NOT AVAILABLE ')
	    menu()
	elif bm =='4':
...
def pb():
	...
	print
	raw_input(R + 'Back')
	os.system('python2 Sarvesh12.py')
